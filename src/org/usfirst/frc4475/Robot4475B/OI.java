...
public class OI {
    ...
    public JoystickButton joystickButton7CatchPosition;
    ...
    public OI() {
        ...
        joystickButton7CatchPosition = new JoystickButton(armGamePad, 5);
        joystickButton7CatchPosition.whenPressed(new MoveToCatchPosition());
        joystickButton5LowerFeeder = new JoystickButton(armGamePad, 7);
        joystickButton5LowerFeeder.whenPressed(new LowerFromCatchPostion());
        ...
        SmartDashboard.putData("MoveToCatchPosition", new MoveToCatchPosition());
        SmartDashboard.putData("MoveArmToCatchPostion", new MoveArmToCatchPostion());
