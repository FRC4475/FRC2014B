...
public class OI {
    ...
    public OI() {
        ...
        joystickButton4Toss3QPower.whenPressed(new TossBall3QPower());
        joystickButton3TossBallHalfPower = new JoystickButton(armGamePad, 3);
        joystickButton3TossBallHalfPower.whenPressed(new TossBallHalfPower());
        joystickButton2TossBallResetPostion = new JoystickButton(armGamePad, 2);
        joystickButton2TossBallResetPostion.whenPressed(new TossBallResetPosition());
        joystickButton1TossFullPower = new JoystickButton(armGamePad, 1);
        joystickButton1TossFullPower.whenPressed(new TossBallFullPower());
